...
function Instr_CRRoutineBegin(trials) {
  return function () {
    ...
    Instr_CRComponents.forEach( function(thisComponent) {
...
function CR_enter_trialRoutineBegin(trials) {
  return function () {
    ...
    CR_enter_trialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function Cr_feedbackRoutineBegin(trials) {
  return function () {
    ...
    Cr_feedbackComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
